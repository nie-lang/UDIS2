...
if __name__=="__main__":
    ...
    parser.add_argument('--path', type=str, default='/opt/data/private/nl/Repository/Unsupervised_Mesh_Stitching/UsupervisedAlignment/RealDataset/DHW-carpark-test/')
